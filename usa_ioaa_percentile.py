...
# Historical IOAA Data for USA (2013 - 2025)
# Format: (Year, USA's Unofficial Team Rank, Total Participating Countries)
# USA first participated in IOAA in 2013.
ioaa_data = [
    (2013, 11, 35),
    (2014, 8, 37),
    (2015, 7, 39),
...
plt.annotate(
    ...
    xytext=(best_year["Year"] - 3, best_year["Percentile"] - 1),
    arrowprops=dict(
...
# Plot customization
plt.title(
    f"USA's IOAA Performance Percentile ({ioaa_data[0][0]} - {ioaa_data[-1][0]})\nRelative Positioning to Overall Pool Size",
    fontsize=16,
    fontweight="bold",
    pad=15,
)
...
plt.tight_layout()
plt.savefig("assets/usa_ioaa_percentile.png")
plt.show()
